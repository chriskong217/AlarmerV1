...
class AlarmList: ObservableObject {
    @Published var alarms: [Alarm] = []
    private var alarmScheduler = AlarmScheduler.shared
    ...
    func updateAlarm(oldAlarm: Alarm, newAlarm: Alarm) {
        if let index = alarms.firstIndex(of: oldAlarm) {
            alarms[index] = newAlarm
            alarmScheduler.updateAlarm(oldAlarm: oldAlarm, newAlarm: newAlarm)
        }
    }
...
struct AlarmListView: View {
    @StateObject private var alarmList = AlarmList()
